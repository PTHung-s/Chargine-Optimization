...
SITE_ID = 'jpl'
START_PAGE_DEFAULT = 1    # Trang bắt đầu nếu chưa có file last_page_downloaded.txt
MAX_PAGES = 100000          # Giới hạn số trang (tránh vòng lặp vô tận)
TIMEOUT = 100                # Timeout request
SLEEP_SECONDS = 5           # Chờ 5s giữa mỗi lần retry
CSV_FILE = 'ev_sessions_GPL.csv'

# File JSON lines (mỗi object 1 dòng)
JSONL_FILE = 'ev_sessions_GPL.jsonl'

# File JSON (một mảng) - chỉ tạo cuối cùng sau khi tải xong
FINAL_JSON_FILE = 'ev_sessions_GPL.json'

# File lưu trang cuối đã tải
PAGE_RECORD_FILE = 'last_page_downloaded2.txt'
